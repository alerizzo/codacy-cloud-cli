...
| `pull-request` | `pr` | ✅ Done (--diff + Diff Coverage Summary + --ai-review added) | [pull-request.md](commands/pull-request.md) |
...
| 2026-07-28 | `pull-request --ai-review` (`-r`): triggers an AI review via `AnalysisService.triggerPullRequestAiReview` (no request body); prints success/failure and returns early, same shape as `--reanalyze` (2 new tests, 480 total) |
